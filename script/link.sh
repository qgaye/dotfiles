rm ~/.zshrc
ln -s ~/Library/Mobile\ Documents/com\~apple\~CloudDocs/Dotfiles/.zshrc ~/.zshrc
...
mkdir ~/.config/nvim
ln -s ~/Library/Mobile\ Documents/com\~apple\~CloudDocs/Dotfiles/init.vim ~/.config/nvim/init.vim
